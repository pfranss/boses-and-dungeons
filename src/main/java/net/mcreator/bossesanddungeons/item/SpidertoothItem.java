...
public class SpidertoothItem extends BossesAndDungeonsModElements.ModElement {
	@ObjectHolder("bosses_and_dungeons:spidertooth")
	public static final Item block = null;
	public SpidertoothItem(BossesAndDungeonsModElements instance) {
		super(instance, 19);
	}
