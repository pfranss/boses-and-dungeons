...
public class SaberItem extends BossesAndDungeonsModElements.ModElement {
	@ObjectHolder("bosses_and_dungeons:saber")
	public static final Item block = null;
	public SaberItem(BossesAndDungeonsModElements instance) {
		super(instance, 1);
	}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Item modifier", (double) 7, AttributeModifier.Operation.ADDITION));
