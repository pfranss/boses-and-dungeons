...
import net.mcreator.bossesanddungeons.entity.KungfumasterEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class KungfumasterRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KungfumasterEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkung_fu_master(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bosses_and_dungeons:textures/kungfu_master.png");
					}
				};
			});
		}
	...
	public static class Modelkung_fu_master extends EntityModel<Entity> {
