...
import net.mcreator.bossesanddungeons.entity.SpiderqueenEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SpiderqueenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SpiderqueenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelspider_queen(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bosses_and_dungeons:textures/spider_queen.png");
					}
				};
			});
		}
