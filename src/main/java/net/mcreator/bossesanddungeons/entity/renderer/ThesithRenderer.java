...
import net.mcreator.bossesanddungeons.entity.ThesithEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ThesithRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ThesithEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelthe_sith(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bosses_and_dungeons:textures/the_sith.png");
					}
				};
			});
		}
