...
import net.mcreator.bossesanddungeons.entity.StormtrooperEntity;
...
public class StormtrooperRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(StormtrooperEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelstorm_trooper(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bosses_and_dungeons:textures/storm_trooper.png");
					}
				};
			});
		}
	...
	public static class Modelstorm_trooper extends EntityModel<Entity> {
